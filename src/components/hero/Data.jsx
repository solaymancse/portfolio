...
export const Data = () => {
  return (
    <div className="hero_data">
        <h1 className="hero_title" data-aos="fade-right" data-aos-duration="1000">Solayman Muhammad 
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="hero_subtitle" data-aos="fade-left"
     data-aos-duration="1000">
           MERN STACK DEVELOPER
        </h3>
        <p className="hero_description" data-aos="fade-left"
     data-aos-duration="1000">Design and Build Dynamic Web Application and responsible for developing, coding, installing, and maintaining software systems.</p>

        <a href="" className="button button--flex" data-aos="fade-up"
     data-aos-duration="1000">Say Hello
        <svg
                  class="button_icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
